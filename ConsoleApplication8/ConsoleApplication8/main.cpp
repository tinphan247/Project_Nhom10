...
//                }
//                else {
//                    showError = true; // Hiển thị thông báo lỗi nếu thông tin đăng nhập không chính xác
//                }
//            }
//        }
//
//        // Nếu đăng nhập thành công, đóng cửa sổ hiện tại và mở cửa sổ mới với 5 button
//        if (loginSuccessful) {
//            CloseWindow(); // Đóng cửa sổ đăng nhập
//            // Khởi tạo cửa sổ mới chứa 5 button
//            InitWindow(screenWidth, screenHeight, "User Dashboard");
//            SetTargetFPS(60);
//
//            Rectangle buttons[5];
...
//
//                    // Placeholder actions for button clicks
//                    if (mouseOverButton[i] && IsMouseButtonPressed(MOUSE_BUTTON_LEFT)) {
//                        DrawRectangleRec(buttons[i], RED);
//                        // Add your actual button actions here
//                        // e.g., if (i == 0) { CreateNewSchoolYear(); }
//                        // Currently just prints a message to the console
//                        switch (i) {
//                        case 0: TraceLog(LOG_INFO, "Create New School Year button clicked"); break;
//                        case 1: TraceLog(LOG_INFO, "Create New Semester button clicked"); break;
//                        case 2: TraceLog(LOG_INFO, "Add New Class button clicked"); break;
//                        case 3: TraceLog(LOG_INFO, "View Classes button clicked"); break;
//                        case 4: TraceLog(LOG_INFO, "Add Student to Class button clicked"); break;
//                        }
//                    }
//                }
//
...
//            }
//
//            CloseWindow(); // Đóng cửa sổ User Dashboard
//            break;
//        }
//
//        // Vẽ giao diện cửa sổ đăng nhập
//        BeginDrawing();
//        ClearBackground(RAYWHITE);
//
...
//    Rectangle loginButton = { screenWidth / 2 - 50, screenHeight / 2 + 70, 100, 40 };
//
//    // Biến boolean để kiểm tra xem nút "Create New School Year" đã được nhấn hay chưa
//    bool createNewYearButtonClicked = false;
//
//    SetTargetFPS(60);
//
//    while (!WindowShouldClose()) {
...
//                        switch (i) {
//                        case 0:
//                            TraceLog(LOG_INFO, "Create New School Year button clicked");
//                            createNewYearButtonClicked = true; // Thiết lập biến khi nút được nhấn
//                            break;
//                        case 1: TraceLog(LOG_INFO, "Create New Semester button clicked"); break;
//                        case 2: TraceLog(LOG_INFO, "Add New Class button clicked"); break;
//                        case 3: TraceLog(LOG_INFO, "View Classes button clicked"); break;
...
//        }
//        char schoolYear[30] = "";
//        // Nếu nút "Create New School Year" đã được nhấn, hiển thị khung nhập kí tự
//        if (createNewYearButtonClicked) {
//            Rectangle schoolYearBox = { screenWidth / 2 - 100, screenHeight / 2 + 120, 200, 40 };
//            DrawText("School Year:", screenWidth / 2 - 100, screenHeight / 2 + 90, 20, DARKGRAY);
//            DrawRectangleRec(schoolYearBox, LIGHTGRAY);
//           DrawText(schoolYear, screenWidth / 2 - 90, screenHeight / 2 + 130, 20, DARKGRAY);
//        }
//
//        EndDrawing();
//    }
...
int main() {
    ...
    if (loginSuccessful && newWindowReady) { // Kiểm tra cả hai điều kiện
        ...
        Rectangle schoolYearInputBox = { screenWidth / 2 - 100, 400, 200, 40 };
        ...
        while (!WindowShouldClose()) {
            ...
            if (createNewSchoolYearActive) {
                ...
                DrawText("Enter School Year (e.g., 2020-2021):", schoolYearInputBox.x, schoolYearInputBox.y - 30, 20, LIGHTGRAY);
